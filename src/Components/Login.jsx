        ...
        <>
            {
                (takeDetail==false ?
                    ...
                    <div className="min-h-60 min-w-72 sm:min-w-96 bg-violet-600 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg flex flex-col justify-center gap-4 items-center p-8 shadow-lg">
                        ...
                        <button className="w-full py-2 mt-4 bg-white text-violet-600 font-bold rounded-md hover:bg-gray-200 flex gap-1 justify-center items-center"> Login <GrLinkNext className='text-lg font-bold' />   </button>
                     </div>
